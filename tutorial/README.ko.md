...
[`https://github.com/zlink-systems/zlink/blob/main/framework/languages/dotnet/tutorial`](https://github.com/zlink-systems/zlink/blob/main/framework/languages/dotnet/tutorial)의 **Channel 메시징과 id로 호출하는 Spot**을
